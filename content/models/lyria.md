...
name: 'Lyria'
slug: 'lyria'
subtitle: 'DeepMind''s music generation model powering Music AI Sandbox'
description: 'DeepMind''s music generation model powering Music AI Sandbox'
company: 'google-deepmind'
model_type: 'Audio Generation'
logo_url: ''
product_url: 'https://deepmind.google/technologies/lyria/'
price: 'Freemium'
rank: 6
...
api_available: true
access_methods: [API]
platforms: ['Vertex AI', 'Music AI Sandbox']
date: '2026-07-16'
tags: [music-generation, audio, api]
---
