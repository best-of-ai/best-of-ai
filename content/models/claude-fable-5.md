...
name: 'Claude Fable 5'
slug: 'claude-fable-5'
subtitle: 'Anthropic''s first Mythos-class model, tuned for the hardest coding benchmarks'
description: 'Anthropic''s first Mythos-class model, tuned for the hardest coding benchmarks'
company: 'anthropic'
model_type: 'Reasoning'
logo_url: ''
product_url: 'https://www.anthropic.com/news/claude-fable-5-mythos-5'
price: 'Paid'
rank: 10
