---
title: 'Leonardo Phoenix'
name: 'Leonardo Phoenix'
slug: 'leonardo-phoenix'
subtitle: 'Leonardo''s in-house flagship model built for prompt adherence and text rendering'
description: 'Leonardo''s in-house flagship model built for prompt adherence and text rendering'
company: 'leonardo-ai'
model_type: 'Image Generation'
logo_url: ''
product_url: 'https://leonardo.ai/models/'
price: 'Freemium'
rank: 6
