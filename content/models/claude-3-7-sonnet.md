...
subtitle: 'Anthropic''s first hybrid reasoning model, blending fast answers with extended thinking'
description: 'Anthropic''s first hybrid reasoning model, blending fast answers with extended thinking'
company: 'anthropic'
model_type: 'Reasoning'
logo_url: ''
product_url: 'https://www.anthropic.com/news/claude-3-7-sonnet'
price: 'Paid'
rank: 8
