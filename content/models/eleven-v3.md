...
name: 'Eleven v3'
slug: 'eleven-v3'
subtitle: 'ElevenLabs'' most expressive text-to-speech model with fine-grained emotional control'
description: 'ElevenLabs'' most expressive text-to-speech model with fine-grained emotional control'
company: 'elevenlabs'
model_type: 'Audio Generation'
logo_url: ''
product_url: 'https://elevenlabs.io/v3'
price: 'Freemium'
rank: 7
...
runs_at_home: false
platforms: ['ElevenLabs app', 'API']
date: '2026-07-16'
tags: [text-to-speech, api, voice-cloning]
---
