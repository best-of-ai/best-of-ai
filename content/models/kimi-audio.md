...
name: 'Kimi-Audio'
slug: 'kimi-audio'
subtitle: 'Moonshot AI''s open-weight audio foundation model for understanding and generating speech'
description: 'Moonshot AI''s open-weight audio foundation model for understanding and generating speech'
company: 'moonshot-ai'
model_type: 'Audio Generation'
logo_url: ''
product_url: 'https://github.com/MoonshotAI/Kimi-Audio'
price: 'Free'
rank: 5
...
runs_at_home: true
platforms: ['Hugging Face', 'Moonshot API']
date: '2026-07-16'
